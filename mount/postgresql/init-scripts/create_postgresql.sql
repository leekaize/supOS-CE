...
INSERT INTO "supos"."supos_resource" VALUES (20, 1, NULL, 2, 'SourceFlow', '/collection-flow', 1, 0, 'SourceFlow.svg', 'menu.desc.nodered.flow', 3, '数据连接', 't', NULL, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO "supos"."supos_resource" VALUES (30, 1, NULL, 2, 'Namespace', '/uns', 1, 0, 'Namespace.svg', 'menu.desc.dataModeling', 2, '数据建模', 't', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "supos"."supos_resource" VALUES (114, 2, 1, 2, 'SourceFlow', '/collection-flow', 1, 0, 'homeSourceFlow.svg', 'menu.desc.nodered.flow', 2, '数据连接', 't', NULL, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO "supos"."supos_resource" VALUES (115, 2, 1, 2, 'Namespace', '/uns', 1, 0, 'homeNamespace.svg', 'menu.desc.dataModeling', 1, '数据建模', 't', NULL, NULL) ON CONFLICT (id) DO NOTHING;
